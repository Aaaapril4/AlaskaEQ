...
size=7
R1=-8000/100/0/20 # histogram
R2=-8000/100/0/1700 # line
R3=-8000/100/0/0.02 # line
J1=X3.2i/0.9i
J2=X3.2i/0.9i
J3=X3.2i/0.9i

# XO start -802.2588366898148 end -204.25883668981479
awk -F, '{print $1, $2, 0.0004}' $numf_simeonof | gmt psxy -R$R1 -J$J1 -Sb1ub0 -W0.01p,darkgray -Gdarkgray -Y8i -K > $PS
...
echo "a)" | gmt pstext -R$R1 -J$J1 -F+cTR+f13p -Dj0.03i/0i -K -O>> $PS

awk -F, '{print $1, $3, 0.0004}' $numf_simeonof | gmt psxy -R$R1 -J$J1 -Sb1ub0 -W0.01p,darkgray -Gdarkgray -Y-1i -K -O >> $PS
...
awk -F, '{print $1, $4, 0.0004}' $numf_simeonof | gmt psxy -R$R1 -J$J1 -Sb1ub0 -W0.01p,darkgray -Gdarkgray -Y-1i -K -O >> $PS
...
-802.2588366898148 0
EOF
gmt psbasemap -R$R1 -J$J1 -By10f2 -Bx2000f500 -BWS -K -O -Bx+l'Days after Simeonof' >> $PS
gmt psbasemap -R$R2 -J$J2 -By800f200 -BE -K -O >> $PS
#endregion
...
R2=-8000/200/0/1000
R3=-8000/100/0/0.015 # line
J1=X3.2i/0.9i
J2=X3.2i/0.9i
J3=X3.2i/0.9i
# XO start -1174.2609663194444 end -576.2609663194445 simeonof -372.00212962962956
awk -F, '{print $1, $2, 0.0004}' $numf_chignik | gmt psxy -R$R1 -J$J1 -Sb1ub0 -W0.01p,darkgray -Gdarkgray -X4i -Y2i -K -O >> $PS
...
gmt psbasemap -R$R1 -J$J1 -By10f2 -Bx2000f500 -BWs  -K -O >> $PS
gmt psbasemap -R$R2 -J$J2 -By500f100 -BE -K -O >> $PS
echo "b)" | gmt pstext -R$R1 -J$J1 -F+cTR+f13p -Dj0.03i/0i -K -O>> $PS

awk -F, '{print $1, $3, 0.0004}' $numf_chignik | gmt psxy -R$R1 -J$J1 -Sb1ub0 -W0.01p,darkgray -Gdarkgray -Y-1i -K -O >> $PS
...
echo -372.00212962962956 $maxh 0  | gmt psxy -R$R1 -J$J1 -Sb0.001b -W0.8p -Gblack -K -O -t50  >> $PS
gmt psbasemap -R$R1 -J$J1 -By10f2 -Bx2000f500 -BWs -K -O >> $PS
gmt psbasemap -R$R2 -J$J2 -By500f100 -BE -By+l'# Accumulated Events' -K -O >> $PS

awk -F, '{print $1, $4, 0.0004}' $numf_chignik | gmt psxy -R$R1 -J$J1 -Sb1ub0 -W0.01p,darkgray -Gdarkgray -Y-1i -K -O >> $PS
...
EOF
echo -372.00212962962956 $maxh 0  | gmt psxy -R$R1 -J$J1 -Sb0.001b -W0.8p -Gblack -K -O -t50  >> $PS
gmt psbasemap -R$R1 -J$J1 -By10f2 -Bx2000f500 -BWS -Bx+l'Days after Chignik' -K -O >> $PS
gmt psbasemap -R$R2 -J$J2 -By500f100 -BE -K -O >> $PS
#endregion
...
R1=-8000/100/0/$maxh # histogram
R2=-8000/200/0/4000
R3=-8000/100/0/0.05 # line
J1=X3.2i/0.9i
J2=X3.2i/0.9i
J3=X3.2i/0.9i

# XO start -1891.2835782175925 end -1293.2835782175928 simeonof -1089.0247415277777 chignik -717.022611898148
awk -F, '{print $1, $2, 0.0004}' $numf_sandpoint2023 | gmt psxy -R$R1 -J$J1 -Sb1ub0 -W0.01p,darkgray -Gdarkgray -X-4i -Y-1.5i -K -O >> $PS
...
gmt psbasemap -R$R1 -J$J1 -By40f5 -Bx2000f500 -BWs  -K -O >> $PS
gmt psbasemap -R$R2 -J$J2 -By1000f200 -BE -K -O >> $PS
echo "c)" | gmt pstext -R$R1 -J$J1 -F+cTR+f13p -Dj0.03i/0i -K -O>> $PS

awk -F, '{print $1, $3, 0.0004}' $numf_sandpoint2023 | gmt psxy -R$R1 -J$J1 -Sb1ub0 -W0.01p,darkgray -Gdarkgray -Y-1i -K -O >> $PS
...
echo -1089.0247415277777 $maxh 0  | gmt psxy -R$R1 -J$J1 -Sb0.001b -W0.8p -Gblack -K -O -t50 >> $PS
echo -717.022611898148 $maxh 0  | gmt psxy -R$R1 -J$J1 -Sb0.001b -W0.8p -Gblack -K -O -t50 >> $PS
gmt psbasemap -R$R1 -J$J1 -By40f5 -Bx2000f500 -BWs -By+l'# Events per day' -K -O >> $PS
gmt psbasemap -R$R2 -J$J2 -By1000f200 -BE -K -O >> $PS

awk -F, '{print $1, $4, 0.0004}' $numf_sandpoint2023 | gmt psxy -R$R1 -J$J1 -Sb1ub0 -W0.01p,darkgray -Gdarkgray -Y-1i -K -O >> $PS
...
echo -1089.0247415277777 $maxh 0  | gmt psxy -R$R1 -J$J1 -Sb0.001b -W0.8p -Gblack -K -O -t50 >> $PS
echo -717.022611898148 $maxh 0  | gmt psxy -R$R1 -J$J1 -Sb0.001b -W0.8p -Gblack -K -O -t50 >> $PS
gmt psbasemap -R$R1 -J$J1 -By10f2 -Bx2000f500 -BWS -Bx+l'Days after Sand Point 2023' -K -O >> $PS
gmt psbasemap -R$R2 -J$J2 -By1000f200 -BE -K -O >> $PS
#endregion
...
R1=-8000/100/0/$maxh # histogram
R2=-8000/200/0/250
R3=-8000/100/0/0.005 # line
J1=X3.2i/0.9i
J2=X3.2i/0.9i
J3=X3.2i/0.9i

# XO start -891.871292824074 end -293.8712928240741 simeonof -89.61245613425926
awk -F, '{print $1, $2, 0.0004}' $numf_sandpoint | gmt psxy -R$R1 -J$J1 -Sb1ub0 -W0.01p,darkgray -Gdarkgray  -X4i -Y2i -K -O >> $PS
...
awk -F, '{print $1, $3, 0.0004}' $numf_sandpoint | gmt psxy -R$R1 -J$J1 -Sb1ub0 -W0.01p,darkgray -Gdarkgray -Y-1i -K -O >> $PS
...
awk -F, '{print $1, $4, 0.0004}' $numf_sandpoint | gmt psxy -R$R1 -J$J1 -Sb1ub0 -W0.01p,darkgray -Gdarkgray -Y-1i -K -O >> $PS
...
EOF
echo -89.61245613425926 $maxh 0  | gmt psxy -R$R1 -J$J1 -Sb0.001b -W0.8p -Gblack -K -O -t50 >> $PS
gmt psbasemap -R$R1 -J$J1 -By4f1 -Bx2000f500 -BWS -Bx+l'Days after Sand Point' -K -O >> $PS
gmt psbasemap -R$R2 -J$J2 -By100f20 -BE -K -O >> $PS
#endregion
