...
seisf2=/mnt/scratch/jieyaqi/alaska/manual_pick_test/catalogs_tomodd_Alaska.csv
seisf3=/mnt/scratch/jieyaqi/alaska/manual_pick_test/catalogs_tomodd_constant.csv
seisf4=/mnt/scratch/jieyaqi/alaska/manual_pick_test/catalogs_tomodd_PREM.csv
cmtf=../data/cmt.csv
...
gmt pscoast -R$R -J$J -W0.5p,"#444444" -A$coast -Df -K -O >> $PS
echo "B) GaMMA-1D+Alaska" | gmt pstext -R$R -J$J -F+cBL+f10p -Dj0.05i/0.05i -K -O>> $PS
gmt psbasemap -R$R -J$J -Bx5f1 -By2f1 -BwseN -O -K >> $PS 
...
gmt pscoast -R$R -J$J -W0.5p,"#444444" -A$coast -Df -K -O >> $PS
echo "C) GaMMA" | gmt pstext -R$R -J$J -F+cBL+f10p -Dj0.05i/0.05i -K -O>> $PS
gmt psbasemap -R$R -J$J -Bx5f1 -By2f1 -BWsen -O -K >> $PS 
...
gmt pscoast -R$R -J$J -W0.5p,"#444444" -A$coast -Df -K -O >> $PS
echo "D) GaMMA-1D+PREM" | gmt pstext -R$R -J$J -F+cBL+f10p -Dj0.05i/0.05i -K -O>> $PS
