...
plot_cross_section() {
    ...
    # CMT
    ## Sand Point
    awk -F, '$22 && $20 && $20>=0 && $20<='$range' {print $5, $6, $7, $22, $23, $24, $25, $26, $27, $28, $1, $7, $20}' staXY |\
    while read line
    do
    ...
    awk -F, '$22 && $19 && $19>=0 && $19<='$range' {print $5, $6, $7, $22, $23, $24, $25, $26, $27, $28, $1, $7, $19}' staXY |\
    while read line
    do
        value=`echo $line | awk '{print $13}'`
    ...
    awk -F, '$22 && $21 && $21>=0 && $21<='$range' {print $5, $6, $7, $22, $23, $24, $25, $26, $27, $28, $1, $7, $21}' staXY |\
    while read line
    do
        value=`echo $line | awk '{print $13}'`
...
awk -F, '$16 && $16>=0 && $16<='$range' && NR>1 {print $2, $3, $16}' $seisf | gmt psxy -R$R -J$J -Sc3p -W0.5p+cl -Csimeonof.cpt -K -O >> $PS
...
awk -F, '$17 && $17>=0 && $17<='$range' && NR>1 {print $2, $3, $17}' $seisf | gmt psxy -R$R -J$J -Sc3p -W0.5p+cl -Csandpoint.cpt -K -O >> $PS
...
awk -F, '$18 && $18>=0 && $18<='$range' && NR>1 {print $2, $3, $18}' $seisf | gmt psxy -R$R -J$J -Sc3p  -W0.5p+cl -Cchignik.cpt -K -O >> $PS
...
plot_cross_section -160.2 54.5646 -159.2 54.5646 100 25 $range 3.3 1.5 W e s A
plot_cross_section -159.6656 56 -159.6656 53.3 100 25 $range 1.15 1.5 w E s B
plot_cross_section -161.3 55.9 -160 53.25 100 25 $range -4.45 -0.4 W e s C
plot_cross_section -160.5 56.05 -159.1 53.40 100 25 $range 4.45 1.5  w E s D
plot_cross_section -159.72 56.13 -158.15 53.55 100 25 $range -4.45 -0.4 W e s E
plot_cross_section -158.95 56.3 -157.2 53.75 100 25 $range 4.45 1.5 w E s F
plot_cross_section -158.1 56.5 -156.2 53.9 100 25 $range -4.45 -0.4 W e S G
plot_cross_section -157.5 56.75 -155.25 54.15 100 25 $range 4.45 1.5 w E S H
