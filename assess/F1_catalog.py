...
if __name__ == '__main__':
    ...
    # manual['timestamp'] = manual['timestamp'].apply(lambda x: UTCDateTime(x))
    # pntf = pd.read_csv('/mnt/scratch/jieyaqi/alaska/final/pntf_alaska_all/picks_gamma.csv')
    # pntf_cat = pd.read_csv('/mnt/scratch/jieyaqi/alaska/final/pntf_alaska_all/catalog_bootstrap_new.csv')
