...
def process_dir_rank(dirnum_this_rank: list, dirmap: dict):
    ...
    for num in dirnum_this_rank:
        ...
        generate_yaml('scripts_phasenet/alaska_v2.yaml', str(Path('/mnt/home/jieyaqi/code/PhaseNet-TF/configs/experiment') / f'alaska_v2{num}.yaml'), num)
        per_index(num, str(dirmap[num]), str(root / f'data{num}.sqlite'))
    return
